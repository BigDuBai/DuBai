...
- (void)viewDidLoad
{
    ...
    [self showContentControllerWithModel:@"MasterViewController"];
...
//    UIViewController *controller = _controllersDict[className];
    ...
    UIViewController *controller = [mainStoryBoard instantiateViewControllerWithIdentifier:@"MasterViewController"];
    if (!controller)
    {
